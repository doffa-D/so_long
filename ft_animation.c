...
/*   Updated: 2022/11/21 19:35:38 by hdagdagu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int enemy(t_data *img,int i,int z)
{
    ...
    if(r <= ENEMY_ANIMATION)
        mlx_put_image_to_window(img->mlx , img->win , img->enemy1.img , i*50 ,z*50);
    else if((r > ENEMY_ANIMATION ) && (r <= ENEMY_ANIMATION + 60))
        mlx_put_image_to_window(img->mlx , img->win , img->enemy2.img , i*50 ,z*50);
    else if((r > ENEMY_ANIMATION + 60) && (r <= ENEMY_ANIMATION + 120))
        mlx_put_image_to_window(img->mlx , img->win , img->enemy3.img , i*50 ,z*50);
    else if((r > ENEMY_ANIMATION + 120) && (r <= ENEMY_ANIMATION + 180))
        mlx_put_image_to_window(img->mlx , img->win , img->enemy4.img , i*50 ,z*50);
    else if((r > ENEMY_ANIMATION + 180) && (r <= ENEMY_ANIMATION + 240))
        mlx_put_image_to_window(img->mlx , img->win , img->enemy5.img , i*50 ,z*50);
    else if((r > ENEMY_ANIMATION + 240) && (r <= ENEMY_ANIMATION + 300))
        mlx_put_image_to_window(img->mlx , img->win , img->enemy6.img , i*50 ,z*50);
...
int coins(t_data *img,int i,int z)
{
    ...
    if(r <= COIN_ANIMATION)
        ...
        mlx_put_image_to_window(img->mlx , img->win , img->coin2.img , i*50 ,z*50);
    else if((r > COIN_ANIMATION + 60) && (r <= COIN_ANIMATION + 120))
        mlx_put_image_to_window(img->mlx , img->win , img->coin3.img , i*50 ,z*50);
    else if((r > COIN_ANIMATION + 120) && (r <= COIN_ANIMATION + 180))
        mlx_put_image_to_window(img->mlx , img->win , img->coin4.img , i*50 ,z*50);
    else if((r > COIN_ANIMATION + 180) && (r <= COIN_ANIMATION + 240))
        mlx_put_image_to_window(img->mlx , img->win , img->coin5.img , i*50 ,z*50);
    else if((r > COIN_ANIMATION + 240) && (r <= COIN_ANIMATION + 300))
        mlx_put_image_to_window(img->mlx , img->win , img->coin6.img , i*50 ,z*50);
...
int ft_animation(t_data *img)
{
    ...
    {
	    mlx_string_put(img->mlx, img->win, (50*img->map.linesize)/2-30, (50*img->map.xsize)/2,  0x00FF0000, " you dead ");
    ...
    if(img->coin1.i == 0 && (img->mob.localz / 50) == img->dor.localz && (img->mob.locali / 50) == img->dor.locali)
	    mlx_string_put(img->mlx, img->win, (50*img->map.linesize)/2-30, (50*img->map.xsize)/2,  0x00B64F, " You win ");
    return 0;
}